                    ...
                    <div class="panel panel-default">
                       ...
                       <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                        //display data
                                      echo  $sql = " select temp.*,c.company_name from
(select user_account.id,job_post.job_title,a.apply_date,a.id,job_post.company_id
from job_post_activity a
inner join user_account on a.user_account_id = user_account.id
inner join job_post a.job_post_id = job_post.id WHERE user_account.id='".$userIdDb."') temp
inner join company c on temp.company_id = c.id";
                                    ...
                                    <tr class="<?php echo $class?> gradeX" id="record_<?php echo $recordId?>">
                                        ...
                                        <td class="center text-center"><a href="job-detail.php?id=<?= $recordId;?>&userid=<?php echo $postedById;?>"><i class="fa fa-edit fa-2x"></i></a></td>
